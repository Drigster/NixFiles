...
sudo nixos-rebuild switch --upgrade --flake ~/etc/nixos#$1 &>nixos-switch.log || (cat nixos-switch.log | grep --color error && exit 1)
...
# Notify all OK!
dunstify "NixOS Rebuilt OK!" --icon=software-update-available